/*Dtx Chart Drawing Module for Modern Browsers
  Author: KSMING
*/
'use strict';

var DtxModule = (function(mod){
...
//				decodeFunctionMap[key](self.dtxdata, value);
//			}
...
//        };
    ...
    //Method: 
    DtxParser2.prototype.parseDtxText = function(dtxText){
        ...
        for (var i = 0; i <= this._largestBarIndex; i++) {
            ...
            this.dtxdata.barGroups.push(barGroup);
        }
    ...
    //Method: clear()
    DtxParser2.prototype.clear = function(){
        this.dtxdata = initializeDtxData();
        //
		this._largestBarIndex = -1;
		this._rawBarLines = {};
    ...
    //Internal methods are denoted with a first underscore
    DtxParser2.prototype._parseTextLine = function(line){
        var trimLine = trimExternalWhiteSpace(line);
        ...
        //Select which decode function to use
        if(decodeFunctionMap.hasOwnProperty(key)){
            decodeFunctionMap[key](this.dtxdata, value);
        }
        else if(key.length === 5 && key.indexOf('BPM') === 0){
    ...
    DtxParser2.prototype._createBarGroup = function(rawLinesInBar){
        ...
        for(var prop in rawLinesInBar){
            ...
            if(rawLinesInBar.hasOwnProperty(prop) && DtxLaneCodeToLaneLabelMap.hasOwnProperty(prop)){
                ...
                this.dtxdata.metadata[countLabel] += chipCount;
                this.dtxdata.metadata.totalNoteCount += chipCount;
            }
        }       
